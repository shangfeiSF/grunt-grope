...
var config = {
  ...
  compress: {
    ...
    dest: ['main', 'build', pkg.name + '.uglify', pkg.version].join('/'),
      ...
      files: [
        {
          ...
          dest: [config.compress.dest, 'compress', config.compress.filename + '.js'].join('/')
        }
      ]
    },
      ...
      files: [
        {
          ...
          dest: [config.beautify.dest, 'beautify', config.beautify.filename + '.js'].join('/')
        }
      ]
    },
      ...
      files: [
        {
          ...
          dest: [config.remain.dest, 'remain'].join('/')
        }
      ]
    }
  }
